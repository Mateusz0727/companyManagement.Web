            ...
            <div className="profile-card">
              ...
              <div className="profile-details">
                  ...
                  <div className="profile-information">
                    ...
                    <div >
                      <input type="checkbox" checked={profile.emailConfirmed || false}  disabled="disabled"/>
                    </div>
                    <div >
                       <h5>{profile.phoneNumber}</h5>
                    </div>                   
                    <div >
                      <input type="checkbox" checked={profile.phoneNumberConfirmed || false} disabled="disabled"/>
                    </div>                   
                    <div >
